...
Public Class administratorUserManagementRestaurant
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim clsRestaurant As Merchant = New Merchant()
        rptAdminRestaurant.DataSource = clsRestaurant.GetRestaurantDetailByAdmin()
        rptAdminRestaurant.DataBind()
    End Sub

    Protected Sub rptAdminRestaurant_ItemDataBound(sender As Object, e As RepeaterItemEventArgs)

    End Sub



    Protected Sub rptAdminRestaurant_ItemCommand(source As Object, e As RepeaterCommandEventArgs)
        ...
        If (e.CommandName = "Activate") Then
            ...
            sb1.Append("alert('")
            sb1.Append(message1)
            sb1.Append("');window.location='administratorUserManagementRestaurant.aspx';};")
            sb1.Append("</script>")
            ...
            Dim subject As String = "Restaurant Manager account ----- Activate"
            Dim body As String = "Dear Restaurant Manager , we are pleased to inform you that your account is activated."
            ...
            If result Then
                ...
                sb2.Append("alert('")
                sb2.Append(message2)
                sb2.Append("');window.location='administratorUserManagementRestaurant.aspx';};")
                sb2.Append("</script>")
            ...
            Else
                ...
                sb3.Append("alert('")
                sb3.Append(message3)
                sb3.Append("');window.location='administratorUserManagementRestaurant.aspx';};")
                sb3.Append("</script>")
        ...
        ElseIf (e.CommandName = "Deactivate") Then
            ...
            sb.Append("alert('")
            sb.Append(message1)
            sb.Append("');window.location='administratorUserManagementRestaurant.aspx';};")
            sb.Append("</script>")
            ...
            Dim ToAddressies As String() = {user.email}
            Dim attachs() As String = {}
            Dim subject As String = "Restaurant Manager account ----- Deactivate"
            Dim body As String = "Dear Restaurant Manager, we are sorry to inform you that your account is deactivated"
            Dim result As Boolean = mail.SendMail(ToAddressies, subject, body, attachs)
            If result Then
                message2 = "Email is sent "
                Dim sb2 As New System.Text.StringBuilder()
        ...
        ElseIf (e.CommandName = "Block") Then
            ...
            Dim ToAddressies As String() = {user.email}
            Dim attachs() As String = {}
            Dim subject As String = "Restaurant Manager account ----- Blocked"
            Dim body As String = "Dear Restaurant Manager, we are sorry to inform you that your account is blocked"
            Dim result As Boolean = mail.SendMail(ToAddressies, subject, body, attachs)
            If result Then
                message2 = "Email is sent "
                Dim sb2 As New System.Text.StringBuilder()
