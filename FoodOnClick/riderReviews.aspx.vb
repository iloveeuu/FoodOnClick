Public Class riderReviews
    ...
    Protected Sub btnSearch_Click(sender As Object, e As EventArgs)
        ...
        Else
            ...
            rptReview.DataSource = clsReview.RetrieveRiderReviewsByDate(Convert.ToInt32(Session("userid")), dateFrom.Text.Trim(), dateTo.Text.Trim())
            rptReview.DataBind()
        End If
    End Sub
    ...
    Protected Sub bindData()
        ...
        Dim clsReview As Review = New Review()
        rptReview.DataSource = clsReview.RetrieveRiderReviews(Convert.ToInt32(Session("userid")))
        rptReview.DataBind()
    End Sub
